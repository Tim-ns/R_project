...
gifts_age_percentages_long_categories <- gifts_age_ext %>%
  select(Age, Age_cat, Candy:GiftCards) %>% # Select Age and all gift categories
  pivot_longer(
    cols = Candy:GiftCards, # Pivot all gift category columns
    names_to = "Category",
    values_to = "PercentageOfPeople" # Name the new value column 'PercentageOfPeople'
  ) %>%
